...
while True:
    ...
    Bola_de_fogo = sprites.create(img("""
        ...
        """),
        SpriteKind.enemy)
    Bola_de_fogo.set_position(randint(0, 200), 15)
    Bola_de_fogo.set_scale(2, ScaleAnchor.MIDDLE)
    Bola_de_fogo.set_velocity(0, 50)
